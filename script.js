...
function met() {
  fetch('https://blr1.blynk.cloud/external/api/get?token=APuw3xTam8hTBHUTbSpt-c36Hf2HO2x0&v6').then((data)=>{
    return data.json();
  }).then((completedata)=>{
    console.log(completedata);
...
function rain() {
  fetch('https://blr1.blynk.cloud/external/api/get?token=APuw3xTam8hTBHUTbSpt-c36Hf2HO2x0&v10').then((data)=>{
    return data.json();
  }).then((completedata)=>{
    console.log(completedata);
    rain = completedata;
